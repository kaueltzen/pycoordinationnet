...
class LitTransformerCoordinationFeaturesData(LitDataset):
    ...
    def get_dataloader(self, data):
        return TransformerCoordinationFeaturesLoader(data, batch_size = self.batch_size, num_workers = self.num_workers)
...
class TransformerCoordinationNet:
    ...
    def train(self, data : Union[CoordinationFeaturesData, BatchedTransformerCoordinationFeaturesData]):

        data = self.prepare_data(data)
        data = LitTransformerCoordinationFeaturesData(data, **self.lit_model.data_options)
    ...
    def test(self, data : Union[CoordinationFeaturesData, BatchedTransformerCoordinationFeaturesData]):
    ...
    def prepare_data(self, data):
        ...
        if isinstance(data, torch.utils.data.Subset):
            ...
            if not (isinstance(data, CoordinationFeaturesData) or isinstance(data, BatchedTransformerCoordinationFeaturesData)):
            ...
            if isinstance(data, CoordinationFeaturesData):
                data = BatchedTransformerCoordinationFeaturesData(data, self.lit_model.model.model_config, self.lit_model.data_options['batch_size'], cache_file = self.cache_file)
